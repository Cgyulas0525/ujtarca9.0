...
@include('resources.views.modal.partner_modal.partner_modal')
@include('resources.views.modal.delivery_modal.delivery_modal')
@include('resources.views.modal.location_modal.location_modal')
