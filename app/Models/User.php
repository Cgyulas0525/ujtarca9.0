 ...
 * @property-read \App\Models\Userstatuses|null $userstatus
...
class User extends Authenticatable
{
    ...
    public function userstatus(): string|BelongsTo
    {
        return $this->belongsTo(Userstatuses::class, 'userstatus_id');
    }
}
