...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('taxnumber', null, ['class' => 'form-control','maxlength' => 15]) !!}
</div>

<!-- Bankaccount Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankaccount', 'Bankaccount:') !!}
    {!! Form::text('bankaccount', null, ['class' => 'form-control','maxlength' => 30]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('phonenumber', null, ['class' => 'form-control','maxlength' => 20]) !!}
</div>
